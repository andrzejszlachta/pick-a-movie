<template>
  <footer>
    <ul class="links">
      <li>
        <a href="https://github.com/andrzejszlachta" target="_blank">
      ...
      <li>
        <a href="https://www.linkedin.com/in/andrzej-szlachta-157947278/" target="_blank">
      ...
      <li>
        <a href = "mailto: andrzej.szlachta@mail.com">
